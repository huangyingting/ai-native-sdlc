...
.app{height:100%}.workspace{height:100%;min-height:0;display:grid;grid-template-columns:minmax(620px,1fr) 340px;grid-template-rows:minmax(0,1fr);gap:1px;overflow:hidden;background:var(--border)}.main,.inspector{min-height:0;background:var(--surface)}
...
@media(min-width:851px){.main,.inspector{height:100%}.inspector{overflow-y:scroll;scrollbar-gutter:stable;contain:size layout}}
...
@media(max-width:850px){body{overflow:auto}.app{height:auto;min-height:100%}.workspace{display:block;height:auto;overflow:visible}.main{min-height:620px}.inspector{border-top:1px solid var(--border)}.trace-meta{display:none}.focus button:not(.active){display:none}.axis,.span-row{grid-template-columns:230px minmax(180px,1fr) 58px 20px}.span-cost,.axis .cost-axis{display:none}}
</style>
</head>
<body>
<div class="app">
