...
All forms default to detailed tracing with redacted request and response payloads. Select **Metadata only** when payload content should not be included in the public HTML artifact.
